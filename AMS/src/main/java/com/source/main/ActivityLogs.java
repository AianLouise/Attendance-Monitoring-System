...
public class ActivityLogs extends javax.swing.JFrame {
    ...
    public ActivityLogs() {
        ...
        try{
            ...
            String sql = "SELECT * FROM tb_logs WHERE user_id = '"+login.id+"'";
            
            ps = conn.prepareStatement(sql);

            rs = ps.executeQuery(sql);
                
            DefaultTableModel tm = (DefaultTableModel)tbl_1.getModel();
            tm.setRowCount(0);
            
            while(rs.next()){
                        Object o[]={rs.getString("username"), rs.getString("date"), rs.getString("status")};
                        tm.addRow(o);
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActivityLogs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActivityLogs().setVisible(true);
            }
        });
    }
